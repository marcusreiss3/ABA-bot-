...
const FRAGMENTS = {
  ...
  hogyoku:           { itemId: "f_hogyoku",          emoji: Emojis.F_HOGYOKU,        minQty: 12, maxQty: 20 },
  pesos_lee:         { itemId: "f_pesoslee",         emoji: Emojis.F_PESOSLEE,       minQty: 12, maxQty: 20 },
  controle_infinito: { itemId: "f_infinito",         emoji: Emojis.F_INFINITO,       minQty: 12, maxQty: 20 },
  chakra_nova_caudas:{ itemId: "f_chakrakurama",     emoji: Emojis.F_CHAKRAKURAMA,   minQty: 12, maxQty: 20 },
  haki_do_rei:       { itemId: "f_haki",             emoji: Emojis.F_HAKI,           minQty: 12, maxQty: 20 },
  capsula_curativa:  { itemId: "f_capsula",          emoji: Emojis.F_CAPSULA,        minQty: 12, maxQty: 20 },
  sharingan:         { itemId: "f_sharingan",        emoji: Emojis.F_SHARINGAN,      minQty: 12, maxQty: 20 },
  roda_mahoraga:     { itemId: "f_rodamahoraga",     emoji: Emojis.F_RODAMAHORAGA,   minQty: 12, maxQty: 20 },
  marca_maldicao:    { itemId: "f_marcamaldi",       emoji: Emojis.F_MARCAMALDI,     minQty: 12, maxQty: 20 },
  dedo_sukuna:       { itemId: "f_sukuna",           emoji: Emojis.F_SUKUNA,         minQty: 12, maxQty: 20 },
  pedra_filosofal:   { itemId: "f_pedrafilosofal",   emoji: Emojis.F_PEDRAFILOSOFAL, minQty: 12, maxQty: 20 },
  esfera_4_estrelas: { itemId: "f_esfera",           emoji: Emojis.F_ESFERA,         minQty: 12, maxQty: 20 },
};
